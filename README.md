...
An overnight scheduled agent run that **burns surplus weekly quota on speculative cross-domain research** paired against your real projects — and only fires when a utilization gate proves the quota would otherwise go unused.
